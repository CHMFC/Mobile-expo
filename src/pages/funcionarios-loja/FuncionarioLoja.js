...
export default function FuncionarioLoja({ route, navigation }) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      await axios
        ...
        .catch((error) => {
          console.error("Erro ao obter lojas na funcionarioLoja", error);
        });
    };
    fetchData();
    ...
    const exibirFuncionarios = async () => {
      await axios
        ...
        .catch(function (error) {
          console.error("Erro ao obter funcionarios na funcionarioLoja", error);
        });
    };
    exibirFuncionarios();
  }, []);
  ...
  const removerFuncionario = async (lojaId, funcionarioId) => {
    try {
      ...
      console.error("Erro ao tentar remover funcionário", error);
    }
  };
