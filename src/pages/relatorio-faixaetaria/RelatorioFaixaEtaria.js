...
export function RelatorioFaixaEtaria({ navigation, route }) {
  ...
  const handleShare = async () => {
    ...
    const fileName = "relatorio-faixa-etaria.pdf";
    ...
    try {
      ...
      await Sharing.shareAsync(uri, {
        dialogTitle: "Compartilhar Relatório de Faixa Etária",
  ...
  const [tokenCelular18a24anos, setTokenCelular18a24anos] = useState(new Set());
  const [tokenCelular25a34anos, setTokenCelular25a34anos] = useState(new Set());
  const [tokenCelular35a44anos, setTokenCelular35a44anos] = useState(new Set());
  const [tokenCelular45a54anos, setTokenCelular45a54anos] = useState(new Set());
  const [tokenCelular55a64anos, setTokenCelular55a64anos] = useState(new Set());
  const [tokenCelular65mais, setTokenCelular65mais] = useState(new Set());
  ...
  useEffect(() => {
    async function pegarClientes() {
        try {
            ...
            setTokenCelular18a24anos(new Set(res.data?.de18a24anos?.clientes?.map(item => item.tokenCelular)));
            setTokenCelular25a34anos(new Set(res.data?.de25a34anos?.clientes?.map(item => item.tokenCelular)));
            setTokenCelular35a44anos(new Set(res.data?.de35a44anos?.clientes?.map(item => item.tokenCelular)));
            setTokenCelular45a54anos(new Set(res.data?.de45a54anos?.clientes?.map(item => item.tokenCelular)));
            setTokenCelular55a64anos(new Set(res.data?.de55a64anos?.clientes?.map(item => item.tokenCelular)));
            setTokenCelular65mais(new Set(res.data?.mais65anos?.clientes?.map(item => item.tokenCelular)));
        } catch (err) {
            console.log(err);
        }
    }
